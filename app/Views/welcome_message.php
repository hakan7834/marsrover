...
<header>
	...
	<div class="menu">
		<ul>
			...
			<li class="menu-item hidden"><a href="/v1/doc">Docs</a>
			</li>
		</ul>
	</div>
	...
	<div class="heroe" style="text-align: center;">
		...
		<h1>Welcome to Mars Rover API</h1>

        <h2 style="font-size:20px;margin-bottom: 300px;">Powered By <a href="https://hakanakhan.com" style="color:rgba(221, 72, 20, .8);text-decoration: none;font-weight: 700;">Hakan AKHAN</a></h2>
...
<section>
    ...
    <p>The information of pages for this case can be found in documentation</p>

    <a href="/v1/doc"><pre style="text-align: center;"><code>GO DOCUMENTATION</code></pre></a>
